...
- In [DocUNet Benchmark](https://www3.cs.stonybrook.edu/~cvl/docunet.html), the '64_1.png' and '64_2.png' distorted images are rotated by 180 degrees, which do not match the ground truth documents. It is ingored by most of existing works. Before evaluation, please make a check.
